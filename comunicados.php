...
header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");require_once("config/config.php");
...
<title>Comunicados - Instituci&oacute;n Educativa Particular Rosa Mar&iacute;a Checa - Chiclayo</title>
<style type="text/css">
<!--
body {
...
.Estilo58 {color: #0066FF; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: smaller; }
.texto1_n {color: #000000}
-->
</style>
...
<table width="1053" border="0" align="center" bgcolor="#FFFFFF">
    ...
    <td colspan="2"><div id="FWTableContainer1283559429">
      <table style="display: inline-table;" border="0" cellpadding="0" cellspacing="0" width="1053">
        ...
        <tr>
          ...
          <td rowspan="3"><a href="noticias.php" target="_top" onmouseout="MM_nbGroup('out');" onmouseover="MM_nbGroup('over','botones_r4_c16_s1','img/botones_r4_c16_s2.gif','img/botones_r4_c16_s4.gif',1);" onclick="MM_nbGroup('down','navbar1','botones_r4_c16_s1','img/botones_r4_c16_s3.gif',1);"><img name="botones_r4_c16_s1" src="img/botones_r4_c16_s1.gif" width="63" height="18" border="0" id="botones_r4_c16_s1" alt="" /></a></td>
  ...
  <tr>
    <td width="296" valign="top"><table width="238" border="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td><a href="artistico.html" target="_top"><img src="imagenes/j2.png" alt="j2" width="288" height="71" border="0" /></a></td>
      </tr>
      <tr>
        <td><a href="deportivo.html" target="_top"><img src="imagenes/j3.png" alt="j3" width="288" height="74" border="0" /></a></td>
      </tr>
      <tr>
        <td><a href="unificacion.html" target="_top"><img src="imagenes/j1.png" alt="j1" width="288" height="71" border="0" /></a></td>
      </tr>
      <tr>
    ...
    <td width="754" valign="top"><table width="754" border="0">
      <tr>
        <td width="748"><!-- Nota --></td>
      </tr>
    </table>
        <table width="748" border="0" align="center" cellpadding='0' cellspacing='0'>
          <tr>
            <td width="658" bgcolor="#008400"><blockquote class="Estilo52">
                <div align="right">COMUNICADOS VIRTUALES </div>
            </blockquote></td>
            <td width="84" bgcolor="#008400"><img src="imagenes/lo2.png" alt="lo2" width="35" height="42" /></td>
          </tr>
          <tr><td><p align="center">
              <table border='0' align='left'>
                  <? if(round($_GET['pag'])>1){$inicio=(($_GET['pag']-1)*10); $pagactual=$_GET['pag']; if($_GET['pag']=='1'){$lim='450';} else {$lim='350';} } else {$lim='350'; $inicio=0; $pagactual=0;} $miconexion->consulta2("select * from comunicado order by com_id desc limit $inicio,10"); while($row_not12=mysql_fetch_array($miconexion->Consulta_ID2)) {$com_1_id2=$row_not12['com_id']; $com_1_ti2=htmlentities($row_not12['com_nom']); $com_1_de2=nl2br(htmlentities($row_not12['com_desc_corta'])); $com_1_fe=explode('-',$row_not12['com_fecha']); $com_dia=$com_1_fe[2]; $com_mes=$com_1_fe[1]; $com_ano=$com_1_fe[0]; $hoy="$com_dia-$com_mes-$com_ano"; $fecha = $hoy; $fechats = strtotime($fecha); switch (date('w', $fechats)) { case 0: $semana="Domingo"; break; case 1: $semana="Lunes"; break; case 2: $semana="Martes"; break; case 3: $semana="Miércoles"; break; case 4: $semana="Jueves"; break; case 5: $semana="Viernes"; break; case 6: $semana="Sábado"; break; } switch ($com_mes) { case 1: $mes_letra="Enero"; break; case 2: $mes_letra="Febrero"; break; case 3: $mes_letra="Marzo"; break; case 4: $mes_letra="Abril"; break; case 5: $mes_letra="Mayo"; break; case 6: $mes_letra="Junio"; break; case 7: $mes_letra="Julio"; break; case 8: $mes_letra="Agosto"; break; case 9: $mes_letra="Septiembre"; break; case 10: $mes_letra="Octubre"; break; case 11: $mes_letra="Noviembre"; break; case 12: $mes_letra="Diciembre"; break; } //a timestamp el parametro w en la funcion date indica que queremos el dia de la semana lo devuelve en numero 0 domingo, 1 lunes,... ?>
                  <tr><td align='center' style='padding-left:25px; padding-right:20px;'><br />
                  <table border='0' width='600'>
                      <tr>
                      <? if(file_exists("comunicado/$com_1_id2.jpg")){?>
                      <td align='center' width='260' valign='top'>
                      <a href="ver_com.php?nt=<?=$com_1_id2?>">
                        <!--<img src='timthumb.php?src=/comunicado/<?//=$com_1_id2?>.jpg&amp;w=250&h=150&amp;zc=1&amp;q=100' border='0' alt=''/>-->
                        <img src='comunicado/<?=$com_1_id2?>.jpg' border='0' alt='' width='250' height='150' /></a></td><?} else { }?>

                      <td valign='top' style='padding-left:15px;' align='left' width='480'>
                          <a href='ver_com.php?nt=<?=$com_1_id2?>' style="font-family: Georgia; color:#222222; font-weight:normal; font-size: 20px;" align='justify'><?=$com_1_ti2?></a>
                          <div style='padding-right:15px; padding-top:5px; padding-bottom:5px; font-size:10px; font-family:Verdana; color:#666666;' align='left'><? echo "$semana, $com_dia de $mes_letra del $com_ano"; ?></div>
                          <div style="color:#222222"><?=$com_1_de2?> ... </div>
                      </td></tr>
                  </table></td></tr><?} ?>
                  <tr>
                      <td align='center' colspan='3'><? $miconexion->consulta("select * from comunicado order by com_id desc"); $numpag=$miconexion->numregistros()/10; if(round($_GET['pag'])>5) { ?> <? } echo"<span class='texto1_n'>&nbsp;Pág.: </span>"; for($i=0;$i<$numpag;$i++){ $ii=$i+1; if($i>=1){echo"<a href='comunicados.php?pag=$ii' class='enlaceboton'";} else {echo"<a href='comunicados.php' class='enlaceboton'";} if(round($_GET['pag'])==$ii) { echo "style='background-color: #CD9933; color: #990000;'"; } echo ">$ii</a>&nbsp;&nbsp;"; } if(round($_GET['pag'])<$numpag-1){ ?> <? } ?>
                      </td>
                  </tr>
              </table></p>
              </td>
...
<table width="1053" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#009900">
  <tr>
